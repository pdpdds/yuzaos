...
extern "C" __declspec(dllexport) PNGLoader * GetImageInterface()
{
...
ImageBuffer* PNGLoader::GetPixelDataFromFile(char* szFileName)
{
	char header[8];
...
ImageBuffer* PNGLoader::GetPixelDataFromBuffer(char* pBuffer, int size)
{
	//not implemented
	return nullptr;
}

bool PNGLoader::SavePixelData(char* szFileName, char* pBuffer, int size)
{
	/* create file */
...
void PNGLoader::ProcessFile(void)
{
