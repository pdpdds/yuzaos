...
inline void fill(char* first,
                 char* last,
                 const char& c) // It's debateable whether we should use 'char& c' or 'char c' here.
{
...
inline void fill(bool* first, bool* last, const bool& b) { memset(first, (char)b, (size_t)(last - first)); }
#endif
