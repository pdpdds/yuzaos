...
struct ExampleAppConsole
{
    ...
    static char* Strdup(const char *str)                             { size_t len = strlen(str) + 1; void* buff = (void*)malloc(len); return (char*)memcpy(buff, (const void*)str, len); }
        ...
        case ImGuiInputTextFlags_CallbackHistory:
            {
                ...
                {
					//20181124
                    //data->CursorPos = data->SelectionStart = data->SelectionEnd = data->BufTextLen = (int)vsnprintf(data->Buf, (size_t)data->BufSize, "%s", (HistoryPos >= 0) ? History[HistoryPos] : "");
                    data->BufDirty = true;
                }
            }
        }
