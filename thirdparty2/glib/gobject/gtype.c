 ...
 * character must be a letter (a¨Cz or A¨CZ) or an underscore (¡®_¡¯). Subsequent
...
extern __declspec(dllexport) void InitializeDll()
{
...
BOOL WINAPI DllMain2 (HINSTANCE hinstDLL,
                     DWORD     fdwReason,
                     LPVOID    lpvReserved);

BOOL WINAPI
DllMain2 (HINSTANCE hinstDLL,
         DWORD     fdwReason,
         LPVOID    lpvReserved)
{
  switch (fdwReason)
