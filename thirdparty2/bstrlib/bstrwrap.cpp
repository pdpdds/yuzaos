...
#ifdef SKYOS32
extern void vsnprintf(char *buf, size_t count, const char *format, va_list arg);
#define exvsnprintf(r,b,n,f,a) {vsnprintf (b,n,f,a); r = strlen(b);}
#elif defined(__WATCOMC__) || defined(_MSC_VER)
#define exvsnprintf(r,b,n,f,a) {_vsnprintf (b,n,f,a); r = strlen(b);}
#else
...
std::ostream& operator << (std::ostream& sout, CBString b) {
	return sout << ((const char *)b, b.length());
}
