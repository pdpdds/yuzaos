// NOTE: modified from https://github.com/ocornut/imgui/blob/master/examples/imgui_impl_sdl.h to expose more function.
// The rendering is handled by imgui_sdl library https://github.com/Tyyppi77/imgui_sdl.
...
IMGUI_API bool ImGui_ImplSDL2_ProcessEvent(const SDL_Event* event);
IMGUI_API void ImGui_ImplSDL2_NewFrame(SDL_Window* window);

IMGUI_API void ImGui_ImplSDL2_UpdateMousePosAndButtons();
IMGUI_API void ImGui_ImplSDL2_UpdateMouseCursor();
IMGUI_API void ImGui_ImplSDL2_UpdateGamepads();
