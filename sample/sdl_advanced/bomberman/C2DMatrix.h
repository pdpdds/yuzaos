...
inline void C2DMatrix::TransformVector2Ds(std::vector<Vector2D> &vPoint)
{
  ...
  {
	  double tempX = (m_Matrix._11*vPoint[i].m_x) + (m_Matrix._21*vPoint[i].m_y) + (m_Matrix._31);

	  double tempY = (m_Matrix._12*vPoint[i].m_x) + (m_Matrix._22*vPoint[i].m_y) + (m_Matrix._32);
...
inline void C2DMatrix::TransformVector2Ds(Vector2D &vPoint)
{
	...
	double tempX = (m_Matrix._11*vPoint.m_x) + (m_Matrix._21*vPoint.m_y) + (m_Matrix._31);

	double tempY = (m_Matrix._12*vPoint.m_x) + (m_Matrix._22*vPoint.m_y) + (m_Matrix._32);
...
inline void C2DMatrix::Rotate(const Vector2D &fwd, const Vector2D &side)
{
  ...
  mat._11 = fwd.m_x;  mat._12 = fwd.m_y; mat._13 = 0;
  
  mat._21 = side.m_x; mat._22 = side.m_y; mat._23 = 0;
