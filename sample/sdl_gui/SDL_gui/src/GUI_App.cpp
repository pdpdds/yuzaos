...
GUI_App *GUI_App::instance = nullptr;
...
GUI_App *GUI_App::create( eastl::string title, int expectedWidth, int expectedHeight, int Orientation, int options ) {
#if defined( __ANDROID__ )
...
GUI_App::GUI_App( int Orientation, eastl::string title, int expectedWidth, int expectedHeight, int options ) :
topView(nullptr),
width(0),
height(0),
topBar(nullptr),
