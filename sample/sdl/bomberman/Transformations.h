                                            ...
                                            const Vector2D   &scale)
{
  ...
  //create a transformation matrix
	...
	//scale
	if ((scale.m_x != 1.0) || (scale.m_y != 1.0))
  {
	  matTransform.Scale(scale.m_x, scale.m_y);
  }
	...
	//and translate
	matTransform.Translate(pos.m_x, pos.m_y);
                                    ...
                                    const Vector2D &AgentPosition)
{
  ...
  //create a transformation matrix
	...
	//and translate
	matTransform.Translate(AgentPosition.m_x, AgentPosition.m_y);
                              ...
                              Vector2D &AgentPosition)
{
  ...
  matTransform._11(AgentHeading.m_x); matTransform._12(AgentSide.m_x);
  matTransform._21(AgentHeading.m_y); matTransform._22(AgentSide.m_y);
