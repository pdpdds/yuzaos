		...
		int x_hot, int y_hot)
{
	...
	convert_bitmap_to_cursor(cursor[cursor_id].cur_bits, (char *)cur_bits, cur_width, cur_height);
	convert_bitmap_to_cursor(cursor[cursor_id].mask_bits, (char *)mask_bits, mask_width, mask_height);
