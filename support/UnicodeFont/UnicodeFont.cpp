...
int UnicodeFont::PutFonts(char *vram, int xsize, int x, int y, unsigned int c, unsigned char *s)
{
...
void UnicodeFont::PutFont16x16(char *vram, int xsize, int x, int y, unsigned int c, char *font)
{
	int i;
	ULONG *p;
	char d[2];
...
void UnicodeFont::PutFont8x16(char *vram, int xsize, int x, int y, unsigned int c, char *font)
{
	int i;
	ULONG *p;
	char d;
