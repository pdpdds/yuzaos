...
#define MB_CUR_MAX 128
	...
	WSTRING_API wchar_t* wcstok(wchar_t* __restrict source, const wchar_t* __restrict delimiters, wchar_t** __restrict lasts);
	WSTRING_API wchar_t* wcsdup(const wchar_t* str);
