...
DECLSPEC int SDLCALL SDL_vsnprintf(char* text, size_t maxlen, const char* fmt, va_list ap) {
	return rSDL_vsnprintf(text, maxlen, fmt, ap);
}

DECLSPEC char* SDLCALL SDL_strdup(const char* string) {
	return rSDL_strdup(string);
}

DECLSPEC char* SDLCALL SDL_getenv(const char* name) {
	return rSDL_getenv(name);
}

DECLSPEC void SDLCALL SDL_free(void* ptr) {
...
DECLSPEC void* SDLCALL SDL_malloc(size_t size) {
	...
	return rSDL_malloc(size);
}

DECLSPEC void* SDLCALL SDL_realloc(void* ptr, size_t size)
{
	return rSDL_realloc(ptr, size);
}

DECLSPEC void* SDLCALL SDL_calloc(size_t nmemb, size_t size)
{
	return rSDL_calloc(nmemb, size);
}
