...
private:
  ...
  Player*     m_pTargetAgent1;
  Player*     m_pTargetAgent2;
  ...
  Vector2D Separation(const std::list<Player*> &agents);
...
public:
  ...
  void      SetTargetAgent1(Player* Agent){ m_pTargetAgent1 = Agent; }
  void      SetTargetAgent2(Player* Agent){ m_pTargetAgent2 = Agent; }
