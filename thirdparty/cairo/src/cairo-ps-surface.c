...
_cairo_win32_tmpfile(void)
{
	...
	snprintf(buf, MAX_PATH, "%stmp.%lu.XXXXXXXXX", path_name, tmpcount);
	++tmpcount;
					      ...
					      double		     height)
{
    ...
    surface->tmpfile = _cairo_win32_tmpfile();
...
/*const char * cairo_ps_level_to_string (cairo_ps_level_t level)
{
    ...
    return (const char* )_cairo_ps_level_strings[level];
}*/

/*const char* cairo_version_string(void)
{
	return (const char* )_cairo_ps_level_strings[0];
}*/
