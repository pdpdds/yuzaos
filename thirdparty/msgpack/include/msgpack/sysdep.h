...
#       elif defined(_byteswap_ushort) || (defined(_MSC_VER) && _MSC_VER >= 1400 && !defined(SKYOS32))
...
#       elif defined(_byteswap_ulong) || (defined(_MSC_VER) && _MSC_VER >= 1400 && !defined(SKYOS32))
...
#   if defined(_byteswap_uint64) || (defined(_MSC_VER) && _MSC_VER >= 1400 && !defined(SKYOS32))
