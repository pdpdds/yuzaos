 ...
 * References in the form [¡ìx.y.z] map to sections in that document.
 *
 *   Author(s): Eduardo Lima Mitev <elima@igalia.com>
 *              Igor Gnatenko <ignatenko@src.gnome.org>
 */

/* SHA-384, SHA-512, SHA-512/224 and SHA-512/256 functions [¡ì4.1.3] */
...
/* SHA-384 and SHA-512 constants [¡ì4.2.3] */
                  ...
                  guint8 const data[SHA2_BLOCK_LEN])
{
  ...
  /* SHA-512 hash computation [¡ì6.4.2] */
