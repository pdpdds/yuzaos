...
SDL2_SYMBOL(SDL_vsnprintf, int, (char *text, size_t maxlen, const char *fmt, va_list ap))
...
SDL2_SYMBOL(SDL_strdup, char *, (const char *string))
SDL2_SYMBOL(SDL_getenv, char *, (const char *name))
SDL2_SYMBOL(SDL_free, void, (void *ptr))
SDL2_SYMBOL(SDL_malloc, void *, (size_t size))
SDL2_SYMBOL(SDL_realloc, void *, (void *ptr, size_t size))
SDL2_SYMBOL(SDL_calloc, void *, (size_t nmemb, size_t size))
