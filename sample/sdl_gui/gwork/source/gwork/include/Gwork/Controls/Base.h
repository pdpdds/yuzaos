...
namespace Gwk
{
    namespace Controls
    {
        ...
        public:
            ...
            typedef eastl::list<Base*> List;

            typedef eastl::map<Gwk::String, Gwk::Event::Caller*> AccelMap;
        ...
        public:
            ...
            virtual void RestrictToParent(bool restrict_)    { m_bRestrictToParent = restrict_; }
