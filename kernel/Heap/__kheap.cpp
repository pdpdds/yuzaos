...
u32int kmalloc_int(u32int sz, int align, u32int *phys)
{
	...
	if (phys != 0)
	{
		//phys = (u32int*)VirtualMemoryManager::GetPhysicalAddress(VirtualMemoryManager::GetKernelPageDirectory(), (uint32_t)addr);
		*phys = (((u32int)addr - g_bootParams._memoryLayout._kHeapBase) + g_bootParams._heapPhysicalStartAddr);
	}
...
heap_t *CreateKernelHeap(u32int start, u32int end_addr, u32int max, u8int supervisor, u8int readonly)
{
	heap_t *heap = &kheap;
