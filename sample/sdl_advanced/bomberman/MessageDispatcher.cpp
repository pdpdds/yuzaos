...
//------------------------------------------------------------------------
void MessageDispatcher::Discharge(GameObject* pReceiver, const Telegram& telegram)
{
                                    ...
                                    void*        AdditionalInfo = NULL)
{
  ...
  //GameObject* pReceiver = EntityMgr->GetEntityFromID(receiver);
	GameObject* pReceiver = m_pLevel->GetGameObjectFromID(receiver);
...
{ 
         ...
         (PriorityQ.begin()->DispatchTime > 0) )
  {
	...
	GameObject* pReceiver = m_pLevel->GetGameObjectFromID(telegram.Receiver);
