...
{
    const unsigned int buf_decompressed_size = stb_decompress_length((unsigned char*)compressed_ttf);
    unsigned char* buf_decompressed_data = (unsigned char*)malloc(buf_decompressed_size);
    stb_decompress(buf_decompressed_data, (unsigned char*)compressed_ttf, compressed_ttf_size);

    SDL_RWops* font = SDL_RWFromMem((void*)buf_decompressed_data, buf_decompressed_size);
...
SDL_RWops* GetFontDataFromMemoryCompressedBase85TTF(const char* compressed_ttf_data_base85)
{
    ...
    void* compressed_ttf = (unsigned char*)malloc((size_t)compressed_ttf_size);
    Decode85((const unsigned char*)compressed_ttf_data_base85, (unsigned char*)compressed_ttf);

    SDL_RWops* font = GetFontDataFromMemoryCompressedTTF((const char*)compressed_ttf, compressed_ttf_size);
    free(compressed_ttf);
