...
class GUI_View {
protected:
	eastl::function<bool(SDL_Event* ev)>user_events_handler;
	eastl::function<void(GUI_View*)>callback;
...
public:
    ...
    void setUserEventHandler(eastl::function<bool(SDL_Event* ev)>userEventHandler );
	...
	eastl::vector<GUI_View *>children;
    GUI_View *parent;
    
    static eastl::vector<GUI_View *>closeQueue;
    ...
    virtual void setCallback(eastl::function<void(GUI_View*)>cb ) {
        callback = cb;
    }
};
