...
static SDL_Scancode SkyOS_Keycodes[] = {
	SDL_SCANCODE_UNKNOWN, /* AKEYCODE_UNKNOWN */
	SDL_SCANCODE_KP_ENTER, /* AKEYCODE_SOFT_LEFT */
...
static SDL_Scancode TranslateKeycode(int keycode)
{
	...
	/*if(scancode != 0)
		scancode = scancode & ~SDLK_SCANCODE_MASK;*/

	return scancode;
}

int
SkyOS_OnKeyDown(int keycode)
{
...
//20201104
	...
	return SDL_SendKeyboardKey(SDL_PRESSED, scanCode);
}

int
SkyOS_OnKeyUp(int keycode)
{	
	int scanCode = TranslateKeycode(keycode);
	...
	return SDL_SendKeyboardKey(SDL_RELEASED, scanCode);
}
