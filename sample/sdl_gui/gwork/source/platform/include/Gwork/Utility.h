...
#define GWK_ARRAY_COUNT(A) (sizeof(A)/sizeof(A[0]))
    ...
    namespace Utility
    {
        GWK_EXPORT int vsnprintf_gwk(char* _str, size_t _count, const char* _format, va_list _argList);
        GWK_EXPORT int vsnwprintf_gwk(wchar_t* _str, size_t _count, const wchar_t* _format, va_list _argList);
        ...
        GWK_EXPORT eastl::wstring Widen(const String &nstr);
        GWK_EXPORT String Narrow(const eastl::wstring &wstr);
        ...
        namespace Strings
        {
            typedef eastl::vector<Gwk::String> List;
