...
#define INCLUDED_eacompiler_H
	...
	//This is duplicated from EABase's eahave.h
			...
			EA_DISABLE_ALL_VC_WARNINGS()
			//#include <windef.h> // Need to trigger the compilation of yvals.h without directly using <yvals.h> because it might not exist.
			EA_RESTORE_ALL_VC_WARNINGS()
		#endif
	...
	//
		...
		#if (defined(_MSC_VER)) && defined(EA_COMPILER_CPP11_ENABLED)
			// supported
