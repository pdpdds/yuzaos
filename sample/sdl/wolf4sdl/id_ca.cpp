...
void CAL_GetGrChunkLength (int chunk)
{
    ...
    fread(&chunkexplen,1, sizeof(chunkexplen), grhandle);
...
//
    for (i=0;i<NUMMAPS;i++)
    {
        ...
        fread ((memptr)mapheaderseg[i],1, sizeof(maptype), maphandle);
    }
