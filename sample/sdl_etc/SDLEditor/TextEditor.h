...
public:
	...
	struct LanguageDefinition
	{
		...
		eastl::string mCommentStart, mCommentEnd, mSingleLineComment;
		char mPreprocChar;
	...
	eastl::string GetSelectedText() const;
	eastl::string GetCurrentLineText()const;
	...
	void InsertText(const eastl::string& aValue);
...
private:
	...
	eastl::string GetWordUnderCursor() const;
	eastl::string GetWordAt(const Coordinates& aCoords) const;
