 ...
 */
/*@null@*/
POPT_DLL_IMPEXP poptContext poptFreeContext( /*@only@*/ /*@null@*/ poptContext con)
	/*@modifies con @*/;
 ...
 */
/*@only@*/ /*@null@*/
POPT_DLL_IMPEXP poptContext poptGetContext(
 ...
 */
/*@null@*/
POPT_DLL_IMPEXP poptContext poptFini( /*@only@*/ /*@null@*/ poptContext con)
	/*@modifies con @*/;
 ...
 */
/*@only@*/ /*@null@*/ /*@unused@*/
POPT_DLL_IMPEXP poptContext poptInit(int argc, /*@dependent@*/ /*@keep@*/ const char ** argv,
		/*@dependent@*/ /*@keep@*/ const struct poptOption * options,
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP void poptResetContext(/*@null@*/poptContext con)
	/*@modifies con @*/;
 ...
 */
POPT_DLL_IMPEXP int poptGetNextOpt(/*@null@*/poptContext con)
	/*@globals fileSystem, internalState @*/
...
POPT_DLL_IMPEXP char * poptGetOptArg(/*@null@*/poptContext con)
	/*@modifies con @*/;
 ...
 */
/*@observer@*/ /*@null@*/ /*@unused@*/
POPT_DLL_IMPEXP const char * poptGetArg(/*@null@*/poptContext con)
	/*@modifies con @*/;
 ...
 */
/*@observer@*/ /*@null@*/ /*@unused@*/
POPT_DLL_IMPEXP const char * poptPeekArg(/*@null@*/poptContext con)
	/*@*/;
 ...
 */
/*@observer@*/ /*@null@*/
POPT_DLL_IMPEXP const char ** poptGetArgs(/*@null@*/poptContext con)
	/*@modifies con @*/;
 ...
 */
/*@observer@*/
POPT_DLL_IMPEXP const char * poptBadOption(/*@null@*/poptContext con, unsigned int flags)
	/*@*/;
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP int poptStuffArgs(poptContext con, /*@keep@*/ const char ** argv)
	/*@modifies con @*/;
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP int poptAddAlias(poptContext con, struct poptAlias alias, int flags)
	/*@modifies con @*/;
 ...
 * @return		0 on success
 */
POPT_DLL_IMPEXP int poptAddItem(poptContext con, poptItem newItem, int flags)
	/*@modifies con @*/;
 ...
 */
POPT_DLL_IMPEXP int poptSaneFile(const char * fn)
 ...
 * return		0 on success
 */
POPT_DLL_IMPEXP int poptReadFile(const char * fn, /*@null@*/ /*@out@*/ char ** bp,
 ...
 */
POPT_DLL_IMPEXP int poptReadConfigFile(poptContext con, const char * fn)
	/*@globals errno, fileSystem, internalState @*/
 ...
 */
POPT_DLL_IMPEXP int poptReadConfigFiles(poptContext con, /*@null@*/ const char * paths)
	/*@globals errno, fileSystem, internalState @*/
	/*@modifies con->execs, con->numExecs,
		errno, fileSystem, internalState @*/;
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP int poptReadDefaultConfig(poptContext con, /*@unused@*/ int useEnv)
	/*@globals fileSystem, internalState @*/
	/*@modifies con->execs, con->numExecs,
 ...
 */
POPT_DLL_IMPEXP int poptDupArgv(int argc, /*@null@*/ const char **argv,
 ...
 * @retval argvPtr	address of returned argument array
 */
POPT_DLL_IMPEXP int poptParseArgvString(const char * s,
 ...
 */
/*@-fcnuse@*/
POPT_DLL_IMPEXP int poptConfigFileToString(FILE *fp, /*@out@*/ char ** argstrp, int flags)
	/*@globals fileSystem @*/
 ...
 */
/*@observer@*/
POPT_DLL_IMPEXP const char * poptStrerror(const int error)
	/*@*/;
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP void poptSetExecPath(poptContext con, const char * path, int allowAbsolute)
	/*@modifies con @*/;
 ...
 * @param flags		(unused)
 */
POPT_DLL_IMPEXP void poptPrintHelp(poptContext con, FILE * fp, /*@unused@*/ int flags)
	/*@globals fileSystem @*/
 ...
 * @param flags		(unused)
 */
POPT_DLL_IMPEXP void poptPrintUsage(poptContext con, FILE * fp, /*@unused@*/ int flags)
	/*@globals fileSystem @*/
	/*@modifies fp, fileSystem @*/;
 ...
 */
/*@-fcnuse@*/
POPT_DLL_IMPEXP void poptSetOtherOptionHelp(poptContext con, const char * text)
	/*@modifies con @*/;
/*@=fcnuse@*/
...
/*@-fcnuse@*/
/*@observer@*/
POPT_DLL_IMPEXP const char * poptGetInvocationName(poptContext con)
	/*@*/;
/*@=fcnuse@*/
 ...
 */
/*@-fcnuse@*/
POPT_DLL_IMPEXP int poptStrippedArgv(poptContext con, int argc, char ** argv)
	/*@modifies *argv @*/;
/*@=fcnuse@*/
 ...
 */
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveString(/*@null@*/ const char *** argvp, unsigned int argInfo,
		/*@null@*/const char * val)
	/*@modifies *argvp @*/;
...
/*@-incondefs@*/
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveLongLong(/*@null@*/ long long * arg, unsigned int argInfo,
		long long aLongLong)
	/*@globals internalState @*/
...
/*@-incondefs@*/
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveLong(/*@null@*/ long * arg, unsigned int argInfo, long aLong)
	/*@globals internalState @*/
	/*@modifies *arg, internalState @*/
	/*@requires maxSet(arg) >= 0 /\ maxRead(arg) == 0 @*/;
/*@=incondefs@*/
...
/*@-incondefs@*/
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveShort(/*@null@*/ short * arg, unsigned int argInfo, long aLong)
	/*@globals internalState @*/
	/*@modifies *arg, internalState @*/
	/*@requires maxSet(arg) >= 0 /\ maxRead(arg) == 0 @*/;
/*@=incondefs@*/
...
/*@-incondefs@*/
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveInt(/*@null@*/ int * arg, unsigned int argInfo, long aLong)
	/*@globals internalState @*/
	/*@modifies *arg, internalState @*/
	/*@requires maxSet(arg) >= 0 /\ maxRead(arg) == 0 @*/;
/*@=incondefs@*/
...
/*@unchecked@*/
POPT_DLL_IMPEXP unsigned int _poptBitsN;
/*@unchecked@*/
POPT_DLL_IMPEXP  unsigned int _poptBitsM;
/*@unchecked@*/
POPT_DLL_IMPEXP  unsigned int _poptBitsK;
/*@=exportlocal =exportvar =globuse @*/

/*@-exportlocal@*/
POPT_DLL_IMPEXP int poptBitsAdd(/*@null@*/poptBits bits, /*@null@*/const char * s)
	/*@modifies bits @*/;
/*@=exportlocal@*/
POPT_DLL_IMPEXP int poptBitsChk(/*@null@*/poptBits bits, /*@null@*/const char * s)
	/*@*/;
POPT_DLL_IMPEXP int poptBitsClr(/*@null@*/poptBits bits)
	/*@modifies bits @*/;
/*@-exportlocal@*/
POPT_DLL_IMPEXP int poptBitsDel(/*@null@*/poptBits bits, /*@null@*/const char * s)
	/*@modifies bits @*/;
/*@-fcnuse@*/
POPT_DLL_IMPEXP int poptBitsIntersect(/*@null@*/ poptBits * ap, /*@null@*/ const poptBits b)
	/*@modifies *ap @*/;
POPT_DLL_IMPEXP int poptBitsUnion(/*@null@*/ poptBits * ap, /*@null@*/ const poptBits b)
	/*@modifies *ap @*/;
POPT_DLL_IMPEXP int poptBitsArgs(/*@null@*/ poptContext con, /*@null@*/ poptBits * ap)
	/*@modifies con, *ap @*/;
/*@=fcnuse@*/
/*@=exportlocal@*/
...
/*@-incondefs@*/
/*@unused@*/
POPT_DLL_IMPEXP int poptSaveBits(/*@null@*/ poptBits * bitsp, unsigned int argInfo,
		/*@null@*/ const char * s)
