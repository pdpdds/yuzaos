...
#if defined(G_OS_UNIX) || defined(SKYOS32)
static GBytes*
                       ...
                       TimeZoneRule **rules)
{
  ...
  if (*pos == '\0')
#if defined(G_OS_WIN32) && !defined(SKYOS32)
 ...
 * `"¡Àhh:mm"`.  ISO 8601 additionally specifies
 * `"¡Àhhmm"` and `"¡Àhh"`.  Offsets are
 ...
 * 02:00:00.
 *
 * In Windows, the "tzn[+|¨C]hh[:mm[:ss]][dzn]" format is used, but also
 ...
 *
 * See
 * [RFC3339 ¡ì5.6](http://tools.ietf.org/html/rfc3339#section-5.6)
