...
private:
  ...
  void openFile(OpenDialog *, const eastl::string &);
  void saveAs(SaveDialog *sender, TextFile *textFile, const eastl::string &fileName);
  void saveAndClose(SaveDialog *sender, TextFile *textFile, const eastl::string &fileName);
